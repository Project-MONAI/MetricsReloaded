...
def test_cldsc():
    ...
    print('clDSC small1',value_test1, np.sum(pred_clDice_small1), np.sum(ref_clDice_small))
    print('clDSC small2',value_test2, np.sum(pred_clDice_small2), np.sum(ref_clDice_small))
...
def test_mismatch_category():
    ref = [pq_ref1, pq_ref2, pq_ref3]
    pred = [pq_pred1, pq_pred2, pq_pred3, pq_pred4]
    mlis = MLIS([[1,1,1,1]], ref_class=[[1,2,2]], pred_loc=[pred],ref_loc=[ref], pred_prob=[[1,1,1,1]],list_values = [1,2], localization='maskiou', measures_detseg=['PQ'],measures_pcc=['fbeta'])
...
def test_localization():
    ...
    mlis1 = MLIS([[1,2]],[[1,2]],[pred],[ref],[[1,1]],[1,2],assignment='Greedy matching',localization='maskcom',thresh=3)
    mlis2 = MLIS([[1,2]],[[1,2]],[pred],[ref],[[1,1]],[1,2],assignment='Greedy matching',localization='maskior',thresh=0)
